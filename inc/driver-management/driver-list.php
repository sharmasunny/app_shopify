			...
			if ( $users_records->num_rows > 0 ) { ?>
				...
				<?php
				 while($users_record = $users_records->fetch_assoc()) {
					...
					$drivername 	  = $users_record['driver_name']." ".$users_record['driver_mname']." ".$users_record['driver_lname'];
					$driverzoneid 	  = $users_record['driver_zone_id'];
					$driverstat	  = $users_record['driver_status'];
					...
					<th><input class="userid" type="checkbox" name="usercodeid[]" id="usercodeid" value="<?php echo $id; ?>" /></th>
						...
						<td style="text-align: center;">							
							...
							{ ?>
								...
								<a onclick="javascript:return confirm('Are you sure, want to disable login of <?php echo $drivername; ?>?')"
							href="inc/driver-management/driver-list-update.php?info=disable&eid=<?php echo $id;?>">
							<img src="images/enable.png" title="Enable" alt="Enabled" />
							...
							{ ?>
								...
								<a  onclick="javascript:return confirm('Are you sure, want to enable login of <?php echo $drivername; ?>?')"
							href="inc/driver-management/driver-list-update.php?info=enable&eid=<?php echo $id;?>">
							<img src="images/disable.png" title="Disable" alt="Disabled" />
